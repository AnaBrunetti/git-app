"""
Django settings for git_app project.
...
SECRET_KEY = 'django-insecure-8at)5wvu^rz6b6$8j701ds)bw0t!x41c(8kl_=#=&w2+@d2q0e'
...
WSGI_APPLICATION = 'git_app.wsgi.application'
